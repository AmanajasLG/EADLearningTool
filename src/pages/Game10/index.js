...
const Game10 = (props) => {
  const load = (missionData, lang, state, setState) => {
    ...
    if(missionData){
      const introText = '<div>Olá! Eu sou ' + missionData.character.name + '! Para planejar a festa, você vai precisar: <ol style="padding-left: 3%"> <li>Servir um prato; </li><li>Se vestir para a festa; e</li><li>Escolher uma trilha sonora!</li></ol></div>'

      const introTextTranslation = <div>Hello! I am {missionData.character.name}! In order to plan the party, you will need:
        <ol style={{paddingLeft: '3%'}}>
          <li>Serve a dish;</li>
          <li>Dress to the party; and</li>
          <li>Chosse a soundtrack!</li>
        </ol>
      </div>
